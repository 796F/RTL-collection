...
void fifo_interface_din(iowidth *din, blockwidth *msg, uint32 *size, uint1 *firstBlock, uint1 *lastBlock)
{
...
#pragma HLS INTERFACE ap_none port=firstBlock
#pragma HLS INTERFACE ap_none port=lastBlock
